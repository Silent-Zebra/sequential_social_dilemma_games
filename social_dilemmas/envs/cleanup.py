...
class CleanupEnv(MapEnv):
    ...
    def __init__(self, ascii_map=CLEANUP_MAP, num_agents=1, render=False, intrinsic_rew_type=None):
        super().__init__(ascii_map, num_agents, render, intrinsic_rew_type=intrinsic_rew_type)
